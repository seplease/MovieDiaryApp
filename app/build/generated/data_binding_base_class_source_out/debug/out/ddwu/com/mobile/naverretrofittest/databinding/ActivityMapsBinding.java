...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  private ActivityMapsBinding(@NonNull RelativeLayout rootView, @NonNull Button btnConfirm) {
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMapsBinding((RelativeLayout) rootView, btnConfirm);
    }
